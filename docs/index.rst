.. django-workflow_config documentation master file, created by
...
WorkflowConfig is an open source and always free workflow framework for ``Django`` which support on
...
.. _`WorkflowConfig Admin`: https://github.com/javrasya/workflow_config-admin

Getting Started
===============

You can easily get started with ``django-workflow_config`` by following :ref:`getting-started`.
