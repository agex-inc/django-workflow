.. django-newname documentation master file, created by
...
NewName is an open source and always free workflowmodel framework for ``Django`` which support on
...
.. _`NewName Admin`: https://github.com/javrasya/newname-admin

Getting Started
===============

You can easily get started with ``django-newname`` by following :ref:`getting-started`.
