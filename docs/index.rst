.. django-workflow documentation master file, created by
...
Workflow is an open source and always free workflowmodel framework for ``Django`` which support on
...
workflowmodel item on the fly.** This means that all the elements in a workflowmodel like
...
.. _`Workflow Admin`: https://github.com/javrasya/workflow-admin

Getting Started
===============

You can easily get started with ``django-workflow`` by following :ref:`getting-started`.
