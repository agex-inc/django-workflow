...
>>> MyModel.workflow.my_state_field.<function>(*args)
...
>>> my_model_objects == MyModel.workflow.my_state_field.get_on_approval_objects(as_user=team_leader)
True
...
>>> State.objects.get(label="open") == MyModel.workflow.my_state_field.initial_state
True
...
>>> State.objects.filter(Q(label="closed") | Q(label="cancelled")) == MyModel.workflow.my_state_field.final_states
True
