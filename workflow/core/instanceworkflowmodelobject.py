...
class InstanceWorkflowModelObject(object):
    ...
    def get_available_approvals(self, as_user=None, destination_state=None, is_return_transition=False):
        qs = self.class_workflowmodel.get_available_approvals(as_user, is_return_transition).filter(object_id=self.workflowmodel_object.pk)
