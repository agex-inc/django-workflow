...
from workflow.admin import OnApprovedHookInline, OnTransitHookInline, OnCompleteHookInline, DefaultWorkflowModelodelAdmin
from workflow.models import Function
from workflow.tests.admin import BasicTestModelAdmin
from workflow.tests.models import BasicTestModel, BasicTestModelWithoutAdmin
