...
from workflow_config.models import TransitionApprovalMeta, Workflow
...
from workflow_config.models.managers.transitionapproval import TransitionApprovalManager
