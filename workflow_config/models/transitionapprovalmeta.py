...
from workflow_config.models import Workflow
from workflow_config.models.base_model import BaseModel
from workflow_config.models.managers.transitionmetada import TransitionApprovalMetadataManager
from workflow_config.models.transitionmeta import TransitionMeta
...
def pre_delete_model(sender, instance, *args, **kwargs):
    from workflow_config.models.transitionapproval import PENDING
