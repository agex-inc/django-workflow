...
from workflow_config.models import Function, OnTransitHook, OnApprovedHook, OnCompleteHook
...
callback_method = """
from workflow_config.tests.hooking.base_hooking_test import callback_output
def handle(context):
    print(context)
    key = '%s'
