...
from workflow_config.admin import OnApprovedHookInline, OnTransitHookInline, OnCompleteHookInline, DefaultWorkflowModelAdmin
from workflow_config.models import Function
from workflow_config.tests.admin import BasicTestModelAdmin
from workflow_config.tests.models import BasicTestModel, BasicTestModelWithoutAdmin
