...
class WorkflowConfigApp(AppConfig):
    ...
    def ready(self):
        ...
        LOGGER.debug('WorkflowConfigApp is loaded.')
    ...
    def _register_hook_inlines(self, model):  # pylint: disable=no-self-use
        ...
        from workflow_config.core.workflowregistry import workflow_registry
        from workflow_config.admin import OnApprovedHookInline, DefaultWorkflowModelAdmin
