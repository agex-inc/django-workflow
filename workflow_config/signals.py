...
from workflow_config.models.on_approved_hook import OnApprovedHook
from workflow_config.models.on_complete_hook import OnCompleteHook
from workflow_config.models.on_transit_hook import OnTransitHook
...
class OnCompleteSignal(object):
    def __init__(self, workflow_object, field_name):
        self.workflow_object = workflow_object
        self.field_name = field_name
        self.workflow = getattr(self.workflow_object.workflow_config, self.field_name)
