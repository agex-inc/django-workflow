...
from newname.models.on_approved_hook import OnApprovedHook
from newname.models.on_complete_hook import OnCompleteHook
from newname.models.on_transit_hook import OnTransitHook
...
class OnCompleteSignal(object):
    def __init__(self, workflowmodel_object, field_name):
        self.workflowmodel_object = workflowmodel_object
        self.field_name = field_name
        self.workflowmodel = getattr(self.workflowmodel_object.newname, self.field_name)
