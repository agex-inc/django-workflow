...
from newname.models import State, WorkflowModel, TransitionMeta
...
from newname.models.base_model import BaseModel
from newname.models.managers.transitionapproval import TransitionApprovalManager
...
class Transition(BaseModel):
    ...
    workflowmodel = models.ForeignKey(WorkflowModel, verbose_name=_("WorkflowModel"), related_name='transitions', on_delete=PROTECT)
