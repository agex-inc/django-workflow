...
from newname.models import WorkflowModel, TransitionMeta
from newname.models.state import State
from newname.models.transitionapprovalmeta import TransitionApprovalMeta
...
class TransitionMetaFactory(DjangoModelFactory):
    ...
    workflowmodel = factory.SubFactory(WorkflowModelFactory)
