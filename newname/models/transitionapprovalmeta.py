...
from newname.models.managers.transitionmetada import TransitionApprovalMetadataManager
from newname.models.transitionmeta import TransitionMeta
...
def pre_delete_model(sender, instance, *args, **kwargs):
    from newname.models.transitionapproval import PENDING
